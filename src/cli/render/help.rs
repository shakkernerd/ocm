    ...
    Some(match action {
        ...
        "clone" => render_leaf(
            ...
            &[
                ...
                "If the config root, mcp, mcp.apps, or mcp.apps.sandboxOrigin is owned by $include, flatten that section before cloning so OCM can reset the origin without changing include ownership.",
